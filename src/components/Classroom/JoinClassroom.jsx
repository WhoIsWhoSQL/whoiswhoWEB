...
export function JoinClassroom() {
    ...
    if (!user.isTeacher) {
        return (
            <Fragment>
                <a href="." className="btn btn-primary btn-icon-split m-2" data-toggle="modal" data-target="#newJoinClassModal">
                ...
                <div className="modal fade" id="newJoinClassModal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">Introduce el pin de la clase:
